      ...
      <div class="content_section floating_element">
        ...
        <div class="content_section_text">
          <p>
                ...
                It is based on the equivalent page on Debian, from which the Debian Apache
...
|       `-- *.conf
        ...
        <div class="content_section_text">
          <p>
                Please use the <tt>debiam-bug</tt> tool to report bugs in the
                Apache2 package with Debian. However, check <a
                href="https://bugs.launchpad.net/debian/+source/apache2">existing
